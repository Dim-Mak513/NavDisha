...
# Wrap all DB work inside the app context
with app.app_context():
    print("⚡ Dropping and recreating tables...")
    db.drop_all()
    db.create_all()

    # Seed internships (30 entries)
    samples = [
    ...
    internships = [
        ...
        for title, company, location, description, tags, stipend, url in samples
    ]

    db.session.bulk_save_objects(internships)
    db.session.commit()

    print("✅ Tables created and internships seeded successfully!")
